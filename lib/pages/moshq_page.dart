...
class _MoshqPageState extends State<MoshqPage> {
  ...
  //await http
  //         .get(Uri.parse('https://iom-2411-1.onrender.com/api/v1/moshqs'));
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    title: Text('Moshq Class Routine'),
                    content: Text(
                        'This page shows the class routine for the Moshq classes. '
                        'You can find the class timings and links to join the Telegram group and Zoom meeting.'),
                    actions: [
                      TextButton(
                        child: Text('Close'),
                        onPressed: () {
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      shrinkWrap:
                          true, // Make sure the ListView takes minimal space
                      physics:
